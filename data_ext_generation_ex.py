...
OUTPUT_FILE = "data/esnli_de_corrected_updated_data_ext_3.xlsx"
...
# Related: 0/1
# Factual: 0/1
# Contains new information: 0/1
# Contains unnecessary information: 0/1
# """.strip()
...
Bewertung: "Well-written":1,"Related":1,"Factual":1,"Contains new information":0,"Contains unnecessary information":0
...
Bewertung: "Well-written":1,"Related":1,"Factual":0,"Contains new information":1,"Contains unnecessary information":0
...
Bewertung: "Well-written":1,"Related":0,"Factual":0,"Contains new information":1,"Contains unnecessary information":0
...
Bewertung: "Well-written":1,"Related":1,"Factual":0,"Contains new information":1,"Contains unnecessary information":1

Beispiel 6 :
Premise: Eine Frau liest ein Buch.
Hypothesis: Die Frau liest.
Explanation: Die Frau hält ein Buch in der Hand und liest darin.
Bewertung: "Well-written":1,"Related":1,"Factual":1,"Contains new information":0,"Contains unnecessary information":1
...
Contains new information – führt Informationen ein, die nicht aus den Sätzen ableitbar sind,
Contains unnecessary information – enthält Details, die für die Begründung der Hypothese irrelevant sind
...
def parse_scores(text: str) -> dict:
    ...
    patterns = {
        ...
        "New Information": r"Contains new information:\s*([01])",
        "Unnecessary Information": r"Contains unnecessary information:\s*([01])"
    }
